...
class DataPreparing:
    ...
    def download_dataset(self):
        ...
        if len(os.listdir(self.save_data_dir)) ==0:
            ...
            corpus = datasets.load_datasets('mt_eng_vietnamese', 'iwslt2015-en-vi')
    ...
    def get_data(self, corpus):
        ...
        target_data = []
        for data in corpus:
            source_data.appned(self.preprocess_text(data['translation'][self.source_lang], self.source_lang))
